                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _ValueItem(
                          ...
                          title: 'Dedication',
                          description: 'Your happiness is our top priority, every time.',
                        ),
...
class _StatCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ).animate().fadeIn(duration: 500.ms, delay: delay).scale(begin: const Offset(0.9, 0.9), end: const Offset(1, 1));
  }
}
